$(document).ready(function () {
  ...
  if ($(window).width() > 767) {
    ...
    about
      .from($(".about-header-text"), 0.33, {
        ease: Power0.easeNone,
        x: "-=70px",
        alpha: 0,
      })
      .to($(".about-header-text"), 0.1, {
        ease: Power0.easeNone,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    about_underline
      .from($(".about-underline"), 0.33, {
        ease: Power2.easeOut,
        x: "+=300",
        alpha: 0,
      })
      .to($(".about-underline"), 0.3, {
        ease: Power2.easeOut,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    responsive_trait
      .from($(".responsive-trait"), 0.33, {
        ease: Expo.easeOut,
        y: "+=300",
        alpha: 0,
        scale: 0,
      })
      .to($(".responsive-trait"), 0.3, {
        ease: Power0.easeNone,
        y: "0",
        alpha: 1,
        scale: 1,
  ...
  if ($(window).width() > 767) {
    ...
    dynamic_trait
      .from($(".dynamic-trait"), 0.33, {
        ease: Expo.easeOut,
        y: "+=300",
        alpha: 0,
        scale: 0,
      })
      .to($(".dynamic-trait"), 0.3, {
        ease: Power0.easeNone,
        y: "0",
        alpha: 1,
        scale: 1,
  ...
  if ($(window).width() > 767) {
    ...
    intuitive_trait
      .from($(".intuitive-trait"), 0.33, {
        ease: Expo.easeOut,
        y: "+=300",
        alpha: 0,
        scale: 0,
      })
      .to($(".intuitive-trait"), 0.3, {
        ease: Power0.easeNone,
        y: "0",
        alpha: 1,
        scale: 1,
  ...
  if ($(window).width() > 991) {
    ...
    strengths_wrapper
      .from($(".strengths-wrapper"), 0.33, {
        ease: Power3.easeOut,
        x: "+=600",
        alpha: 0,
        scale: 0,
      })
      .to($(".strengths-wrapper"), 0.3, {
        ease: Power0.easeNone,
        x: "0",
        alpha: 1,
        scale: 1,
  ...
  if ($(window).width() > 991) {
    ...
    javascript_wrapper
      .from($(".animated-bar-javascript"), 0.33, {
        ease: Power3.easeOut,
        scaleX: 0,
        transformOrigin: "left",
      })
      .to($(".animated-bar-javascript"), 0.3, {
        ease: Power0.easeNone,
        scaleX: 1,
      });
  ...
  if ($(window).width() > 991) {
    ...
    photoshop_wrapper
      .from($(".animated-bar-photoshop"), 0.33, {
        ease: Power3.easeOut,
        scaleX: 0,
        transformOrigin: "left",
      })
      .to($(".animated-bar-photoshop"), 0.3, {
        ease: Power0.easeNone,
        scaleX: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    projects
      .from($(".projects-header-text"), 0.33, {
        ease: Power0.easeNone,
        x: "-=70px",
        alpha: 0,
      })
      .to($(".projects-header-text"), 0.1, {
        ease: Power0.easeNone,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    projects_underline
      .from($(".projects-underline"), 0.33, {
        ease: Power2.easeOut,
        x: "+=300",
        alpha: 0,
      })
      .to($(".projects-underline"), 0.3, {
        ease: Power2.easeOut,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    technologies
      .from($(".technologies-li"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    temple
      .from($(".project-temple"), 0.33, { alpha: 0 })
      .to($(".project-temple"), 0.3, { alpha: 1 });
  ...
  if ($(window).width() > 767) {
    ...
    brooks
      .from($(".project-brooks"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    movie
      .from($(".project-movie"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    thrones
      .from($(".project-thrones"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    emailProject
      .from($(".project-email"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    interests
      .from($(".interests-header"), 0.33, {
        ease: Power0.easeNone,
        x: "-=70px",
        alpha: 0,
      })
      .to($(".interests-header"), 0.1, {
        ease: Power0.easeNone,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    interests_underline
      .from($(".interests-underline"), 0.33, {
        ease: Power2.easeOut,
        x: "+=300",
        alpha: 0,
      })
      .to($(".interests-underline"), 0.3, {
        ease: Power2.easeOut,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    art
      .from($(".interest-art"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    animation
      .from($(".interest-animation"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    travel
      .from($(".interest-travel"), 0.33, { alpha: 0 })
  ...
  if ($(window).width() > 767) {
    ...
    contact
      .from($(".contact-header"), 0.33, {
        ease: Power0.easeNone,
        x: "-=70px",
        alpha: 0,
      })
      .to($(".contact-header"), 0.1, {
        ease: Power0.easeNone,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    contact_underline
      .from($(".contact-underline"), 0.33, {
        ease: Power2.easeOut,
        x: "+=300",
        alpha: 0,
      })
      .to($(".contact-underline"), 0.3, {
        ease: Power2.easeOut,
        x: "0",
        alpha: 1,
      });
  ...
  if ($(window).width() > 767) {
    ...
    linkedin
      .from($(".icon-linkedin"), 0.33, { alpha: 0 })
